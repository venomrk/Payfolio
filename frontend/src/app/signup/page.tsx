        ...
        <main className="min-h-screen flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-h1 text-text-primary mt-6 mb-2">Create your account</h1>
                    <p className="text-text-secondary">Start tracking your finances in minutes</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {/* Name */}
                    <div>
                        <label className="block text-small text-text-secondary mb-2">Full Name</label>
                    ...
                    <p className="text-center text-text-tertiary text-small">
                        By signing up, you agree to our{" "}
                        <Link href="/terms" className="text-wealth-purple hover:underline">Terms</Link>
                        {" "}and{" "}
                        <Link href="/privacy" className="text-wealth-purple hover:underline">Privacy Policy</Link>
                    </p>
                </form>
                ...
                <p className="text-center text-text-secondary mt-8">
                    ...
                    <Link href="/login" className="text-wealth-purple hover:underline">
                        Sign in
                    </Link>
                </p>
            </div>
